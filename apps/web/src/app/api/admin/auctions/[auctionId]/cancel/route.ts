...
import { cancelAdminAuction } from "@/lib/admin/admin-auctions-api";
import { normalizeCancelAuctionRequest } from "@/lib/admin/admin-auction-validation";
...
export async function POST(
  ...
  try {
    return jsonResponse(await cancelAdminAuction(auctionId, normalizeCancelAuctionRequest(body)), 200);
  } catch (error) {
