...
import { publishAdminAuction } from "@/lib/admin/admin-auctions-api";
import { normalizePublishAuctionRequest } from "@/lib/admin/admin-auction-validation";
...
export async function POST(
  ...
  try {
    return jsonResponse(await publishAdminAuction(auctionId, normalizePublishAuctionRequest(body)), 200);
  } catch (error) {
