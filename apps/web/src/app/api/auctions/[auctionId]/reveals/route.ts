...
import { submitBidReveal } from "@/lib/bidder/bidder-auctions-api";
import { normalizeSubmitRevealRequest } from "@/lib/bidder/bidder-auction-validation";
...
export async function POST(
  ...
  try {
    return jsonResponse(
      await submitBidReveal(auctionId, normalizeSubmitRevealRequest(parsed.value)),
      201,
    );
  } catch (error) {
